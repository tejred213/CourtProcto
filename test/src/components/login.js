...
function Login() {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      navigate('/stenographerdash'); // Adjust this as per your app's routes
...
// //     const validRoles = ['Judge', 'Stenographer', 'Lawyer', 'Admin']; // List of valid roles

// //     if (validRoles.includes(role) && email && password) {
// //       // Replace logging with a success message
// //       setMessage('Login successful');

// //       // Simulate navigation after successful login (modify as needed)
// //       setTimeout(() => {
// //         navigate(`/${role.toLowerCase()}dash`); // Navigate to the respective dashboard
// //       }, 1000); // Optional delay to show the message before redirect
// //     } else {
// //       setMessage('Login Failed: invalid email or role'); // Error message
// //     }
// //   };
